  ...
  <body>
    ...
    <div class="container">
	  ...
	  <form action="{{id}}/komentar/" method="POST">
	    <p><input type="text" name="komentar" placeholder="Komentar..."></p>
	    <p><input type="text" name="uporabnisko_ime" placeholder="Uporabniško me..."></p>
