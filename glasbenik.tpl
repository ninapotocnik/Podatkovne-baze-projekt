...
<html lang="sl">
  ...
  <body>
    ...
    <div class="jumbotron">
      <div class="container">
        %for id, datum, glasbenik, ime, cena in podatki_nastop:
	<h3>Izbrali ste nastop <b>{{glasbenik}}</b> na festivalu <b>{{ime}}</b>.</h3>
	%end
	<p>Datum nastopa: <b>{{datum}}</b></p>
	<p>Cena nastopa: <b>{{cena_nastop}}</b> €.</p>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-4">
          <h3>Nakup vstopnice za nastop</h3>
          <p><b>Vpišite število vstopnic, ki jih želite kupiti:</b></p>
	  <form action="{{id}}/nakupljeno">
	    <p><input type="number" name="kolicina" placeholder="Stevilo vstopnic..."></p>
	    <p></p>
            <p></p>
	    <h3>Izberite način plačila: </h3>
	    <ul>
	    <p><li> Kartica: SI56 <input type="number" name="stevilka_kartice" placeholder="Stevilka..."> </li></p>
	    <p><li> Moneta: <input type="number" name="stevilka_monete" placeholder="Stevilka..."></li></p>
	    </ul>
